...
<label  for="reg">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<u><b>EMPLOYEE&nbsp&nbspLOGIN&nbsp&nbspFORM</b></u></label><br><br>
...
$query=mysql_query("select * from employee where username='$username' and password='$password'") or die(mysql_error());
   ...
   $_SESSION['username']=$userrname;
    ...
    //echo "<script> window.open('employee_home.php','_self')</script>";
	header("location: employee_update.php?id=".$username);
   }
   else
   {
