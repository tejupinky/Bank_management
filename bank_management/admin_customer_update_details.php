...
<input placeholder="Enter the customer name" type="text" name="cname" /></br>
...
if($cname == '')
{
echo "<script> alert('Please enter valid customer name')</script>";
exit();
}
...
$query="update customer set cname='$cname' ,password='$password',address='$address'  where username='$username'";
