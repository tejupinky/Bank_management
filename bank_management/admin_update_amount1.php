...
<div>
<form method="post" action="admin_update_amount1.php">
...
<input placeholder="Enter the customer ID" type="text" name="name"/></br>
...
*/
$query="insert into amount(customer_id,amount) values ('$name','$amount')";
if(mysql_query($query))
{

echo "<script> alert('Updated Successfully') </script>";
echo "<br>";
echo " <a href='admin_amount_view.php'>View result</a>"; 
} 
